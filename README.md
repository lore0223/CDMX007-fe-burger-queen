...
En México hay casi 1.6 millones de personas dedicadas a la preparación de comida rápida. Ganan en promedio 32 pesos por hora trabajada, aunque al mes la mayoría genera entre uno y dos salarios mínimos (entre  $2'650 pesos y $5'301 pesos), segun el INEGI y la ENOE (Encuesta Nacional de la Ocupación y el Empleo). Ls mayoría de los empleados de restaurantes de comida rápida **no están satisfechos** con sus empleos actuales.
...
El mapa de empatía arrojó la siguiente información:

**Lo que piensa y siente Alejandra**

-Le frustra el manejo del sistema.
-Le preocupa que el cliente se moleste.
-Le molesta que las opciones de su pantalla no estén organizadas.

**Lo que ve**

-El sistema no es intuitivo.
-Interfaz para tomar las órdenes difícil de usar.
-Tensión por que al principio es muy dificil aprender a usar el sistema.

**Lo que escucha**

-Los clientes solicitan que las órdenes puedan tomarse más rápido.
-Quejas por el servicio.
-Ambiente laboral pesado.

**Lo que quisiera**

*Una interfaz que le permita tomar las órdenes mucho más rápido.
*Que sea fácil de aprender a usar.
*Una interfaz amigable, sencilla y fácil de usar.

Pensando  en estas necesidades en la parte de desarrollo Front-end  decidimos utilizar Angular 7 para construir la interfaz que Brenda propuso. 

La primer historia de usuario definida es la  siguiente.

*H.U.1:*  

Yo como usuario quiero ver los productos del menú, para poder asesorar al comensal de las diferentes opciones.

*D.O.D.* El proyecto debe estar en github. Una compañera debió haber hecho code review de mi app. Hacer pruebas unitarias. Pruebas de usabilidad e incorporar el feedback. Desplegar la app en firebase.

Para desarrollar esta primer historia de usuario realizamos un *diagrama de flujo*
![Diagrama](./src/assets/img-readme/Diagramahu1.png)


*Si quieres conocer el proceso de planeación de este proyecto visita esta liga* [Kanban](https://trello.com/b/WQ53NtWP/burger-queen)
